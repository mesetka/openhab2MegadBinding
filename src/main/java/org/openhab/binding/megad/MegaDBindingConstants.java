...
public class MegaDBindingConstants {
    ...
    public static final ThingTypeUID THING_TYPE_I2CWALLMOUNT = new ThingTypeUID(BINDING_ID, "i2cwallmount");
    public static final ThingTypeUID THING_TYPE_I2CWALLMOUNTNEW = new ThingTypeUID(BINDING_ID, "i2cwallmountnew");
    ...
    public static final String CHANNEL_I2C_LIGHTLEVEL = "lightlevel";
    public static final String CHANNEL_I2C_CO = "co";
